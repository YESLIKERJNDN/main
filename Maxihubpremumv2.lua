...
Frame.Position = UDim2.new(0.263157845, 0, 0.06334842, 0)
Frame.Size = UDim2.new(0, 352, 0, 287)
...
DropShadow.Position = UDim2.new(0.495733798, 0, 0.501742184, 0)
DropShadow.Size = UDim2.new(1.00511944, 47, 1.01045299, 47)
DropShadow.ZIndex = 0
...
ImageLabel.BackgroundColor3 = Color3.fromRGB(64, 64, 64)
ImageLabel.Position = UDim2.new(0.0481694043, 0, 0.0801393688, 0)
...
TextLabel_2.Position = UDim2.new(0.315340906, 0, 0.16724737, 0)
...
TextLabel_3.Position = UDim2.new(0.50999999, 0, -1.18000007, 0)
TextLabel_3.Size = UDim2.new(0, 200, 0, 50)
TextLabel_3.Font = Enum.Font.GothamBold
TextLabel_3.Text = "v2.0.1"
TextLabel_3.TextColor3 = Color3.fromRGB(64, 64, 64)
TextLabel_3.TextSize = 14.000

Load.Name = "Load"
Load.Parent = Frame
Load.BackgroundColor3 = Color3.fromRGB(75, 75, 75)
Load.Position = UDim2.new(0.25, 0, 0.543554008, 0)
...
DropShadowHolder_2.Parent = Load
...
Join.Name = "Join"
Join.Parent = Frame
Join.BackgroundColor3 = Color3.fromRGB(75, 75, 75)
Join.Position = UDim2.new(0.116477266, 0, 0.752613246, 0)
Join.Size = UDim2.new(0, 118, 0, 30)
...
DropShadowHolder_3.Parent = Join
...
Visit.Name = "Visit"
Visit.Parent = Frame
Visit.BackgroundColor3 = Color3.fromRGB(75, 75, 75)
Visit.Position = UDim2.new(0.576704621, 0, 0.752613246, 0)
Visit.Size = UDim2.new(0, 123, 0, 30)
Visit.Font = Enum.Font.GothamBold
Visit.Text = "Visit Website"
Visit.TextColor3 = Color3.fromRGB(0, 0, 0)
Visit.TextSize = 14.000

UICorner_5.CornerRadius = UDim.new(0, 4)
UICorner_5.Parent = Visit

DropShadowHolder_4.Name = "DropShadowHolder"
DropShadowHolder_4.Parent = Visit
...
local function UCIQ_fake_script() -- ImageLabel.LocalScript 
...
coroutine.wrap(UCIQ_fake_script)()
local function DTDJZNI_fake_script() -- TextLabel_2.LocalScript 
...
coroutine.wrap(DTDJZNI_fake_script)()
local function CJIAI_fake_script() -- Frame.LocalScript 
...
coroutine.wrap(CJIAI_fake_script)()


function loadgodmode()
    setclipboard("https://discord.gg/QFQTpW4ruy")
end

Join.MouseButton1Click:Connect(loadgodmode)

function loadgodmode()
    setclipboard("maxihubinfo.com")
end

Visit.MouseButton1Click:Connect(loadgodmode)
...
tab:Button({
    ...
    tab:Button({
    Title = "Anti Fling V2 [Dont Use With Fly]",
    Callback = function()
         -- [ Services ] --
...
Distancia = 30; -- Here put the distance to activate
jugadorcerca = nil;
...
for i,v in pairs(game:GetService("Workspace").Ignored.Drop:GetChildren()) do
    if v.Name == 'MoneyDrop' and (game.Players.LocalPlayer.Character.PrimaryPart.Position - v.Position).Magnitude  < 12 then
...
game.StarterGui:SetCore("SendNotification", {Title = "Maxihub", Text = "Bag All Activated , It Can Only Be Turned Off By Rejoining heh", Icon = "rbxassetid://505845268", Duration = 5, Button1 = "Okay!"})
...
tab:Button({
	...
	game.StarterGui:SetCore("SendNotification", {Title = "MAXIHUB [GUI]", Text = "RPG Control executed, press E to speed up and Q to slow down", Duration = 20
...
x.Text = "MaxiWare Auto Collect Cash [Buggy]"
...
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Ignored.Shop["[Shotgun] - $1250"].Head.CFrame
wait(0.75)
...
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = Pos
    ...
    Callback = function()
         local Pos = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Ignored.Shop["[AK47] - $2250"].Head.CFrame
wait(0.75)
...
Callback = function()
    local Pos = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Ignored.Shop["[Silencer] - $550"].Head.CFrame
wait(0.75)
...
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = Pos
    ...
    tab:Button({
    Title = "Tactical Shotgun [1750$]",
    Callback = function()
          local Pos = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Ignored.Shop["[TacticalShotgun] - $1750"].Head.CFrame
wait(0.75)
...
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = Pos
    ...
    tab:Button({
    Title = "High Medium Armor [2300]",
    Callback = function()
          local Pos = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Ignored.Shop["[High-Medium Armor] - $2300"].Head.CFrame
wait(0.75)
...
local Notification = loadstring(game:HttpGet("https://raw.githubusercontent.com/YESLIKERJNDN/YesBoy/main/Maxihub%20Main.lua", true))()
...
Notification.new("success", "Loaded Antiban", "Loaded.") 
end

game:GetService("StarterGui"):SetCore("SendNotification",{
Title = "Premium (Synxt) Not Found!";
	Text = "D:";
	Time = 3;
})
...
function whitelistcheck()
    for _,Player in pairs(game:GetService('Players'):GetChildren()) do
        if table.find(Premium, Player.UserId) then
            ...
            elseif 
            table.find(Admins, Player.UserId) then 
            if Player.Character then
                if Player.Character.Parent.Name == 'Players' then
...
Load.MouseButton1Click:Connect(loadgodmode)